...
local py = {"raw-coal", "ore-aluminium", "ore-chromium", "ore-lead", "ore-nickel", "ore-tin", "ore-titanium", "antimonium"}
for _, ore in ipairs(py) do table.insert(ores_to_disable, ore) end
--didnt add "quartz-rock", "salt-rock"
local py2 = {"aluminium-rock", "chromium-rock", "lead-rock", "nickel-rock", "tin-rock", "titanium-rock", "zinc-rock"}
